        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Article_FeedSource_FeedSourceId",
                        column: x => x.FeedSourceId,
                        principalTable: "FeedSource",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "FeedSourceTopics",
                columns: table => new
                {
                    FeedSourceId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeedSourceTopics", x => new { x.FeedSourceId, x.TopicId });
                    table.ForeignKey(
                        name: "FK_FeedSourceTopics_FeedSource_FeedSourceId",
                        column: x => x.FeedSourceId,
                        principalTable: "FeedSource",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FeedSourceTopics_Topics_TopicId",
                        column: x => x.TopicId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedSourceTopics_TopicId",
                table: "FeedSourceTopics",
                column: "TopicId");
